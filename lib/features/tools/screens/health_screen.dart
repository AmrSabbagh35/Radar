...
import 'package:earthquake/features/emergency/widgets/meter_widget.dart';
...
class HealthAppState extends State<HealthApp> {
  ...
  Future fetchData() async {
    ...
    if (requested) {
      ...
      showSnackBar(context, 'Authorization not granted');
  ...
  Widget _contentNotFetched() {
    return context.watch<ToolsProvider>().isLoading
        ? const LoadingWidget()
        : Center(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('أداة معلومات الساعة الذكية'),
        ),
        floatingActionButton: Column(
          ...
          children: [
            FloatingActionButton(
              ...
              onPressed: () {
                context.read<ToolsProvider>().updateRiskLevel(
                    context: context,
